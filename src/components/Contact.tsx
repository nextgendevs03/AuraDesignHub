...
const Contact: React.FC = () => {
  ...
  const handleDirectionsClick = () => {
    window.open('https://www.google.com/maps/dir/?api=1&destination=Bhelkenagar,+Kothrud,+Pune,+Maharashtra+411038', '_blank');
  };
  ...
  const contactInfo = [
    {
      ...
      title: "Call Us",
      primary: "+(91) 70282-81032",
      secondary: "Available Mon-Fri 9AM-6PM",
      action: () => window.open('tel:+(91)70282-81032'),
      bgColor: "bg-blue-50",
      iconBg: "bg-blue-100"
    },
    {
      ...
      title: "Email Us",
      primary: "info@auradesignhub.in",
      secondary: "We respond within 24 hours",
      action: () => window.open('mailto:info@auradesignhub.in'),
    ...
    },
    {
      ...
      primary: "Bhelkenagar, Kothrud",
      secondary: "Pune, Maharashtra 411038",
      action: () => window.open('https://maps.google.com/?q=Bhelkenagar,+Kothrud,+Pune,+Maharashtra+411038'),
      bgColor: "bg-green-50",
      iconBg: "bg-green-100"
    },
    {
  ...
  return (
    <section id="contact" className="py-20 bg-[#DDCDB6] from-gray-50 to-white">
            ...
            <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100 h-full">
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="text-3xl font-bold text-gray-900">Find Our Studio</h3>
                </div>
                <button
                  onClick={handleDirectionsClick}
                  className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-xl font-semibold flex items-center space-x-2 transition-all duration-200 transform hover:scale-105"
                >
                  <Navigation size={18} />
...
{/* new map section */}
 ...
 <div className="w-full h-[400px] md:h-[500px] lg:h-[600px]"> 
                <iframe
                  ...
                  src="https://maps.google.com/?q=123+Design+Street,+Creative+City,+CA+90210&output=embed"
                  allowFullScreen
                  loading="lazy"
                  referrerPolicy="no-referrer-when-downgrade"
                  title="Google Maps view of our Studio"
                ></iframe>
              </div>
            </div>
          </div>
