  ...
  return (
    <section id="contact" className="py-20 bg-[#DDCDB6] from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-12 mb-16 items-center">
          ...
          <div className="xl:col-span-2">
            <div className="bg-white p-8 md:p-8 rounded-3xl shadow-xl border border-gray-100">
              <div className="flex items-start space-x-4 mb-8">
                <div className="bg-green-100 p-3 rounded-xl">
                  <MapPin className="w-7 h-7 text-green-700" />
                </div>
                <div>
                  <h3 className="text-3xl font-bold  text-gray-900">Visit Our Studio</h3>
                  <p className="text-lg text-gray-600 mt-1">123 Design Street, Creative City, CA 90210</p>
                </div>
              </div>
              {/* <div className="h-96 w-full rounded-2xl overflow-hidden border-2 border-gray-200"> */}
